<template>
  ...
  <!-- <div class="mt-12 flex justify-center">
    <div>
      <div
        v-for="verse in store.verses.slice(0, 3)"
        class="flex flex-col items-center gap-6 space-y-4 px-4 py-8"
      >
        <div class="text-center font-farsi text-3xl font-bold dark:text-white">
          {{ verse.text_original }}
        </div>
        <TopicInput />
      </div>
